      ...
      <main className="max-w-6xl mx-auto px-4 py-12">
        ...
        <Card>
          <CardHeader>
            ...
            <p className="text-gray-600">Ranked by average score, total quizzes, and best performance</p>
          </CardHeader>
          <CardContent>
          ...
          <Link href="/quizzes" className="inline-block">
            <Card className="inline-block p-6 hover:shadow-lg transition-shadow cursor-pointer">
              <CardContent className="text-center">
                ...
                <p className="text-gray-600">Improve your ranking by taking more quizzes</p>
              </CardContent>
            </Card>
          </Link>
        </div>
