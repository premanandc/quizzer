...
describe('QuizService', () => {
  ...
  describe('getQuiz', () => {
    ...
    it('should return quiz data for valid active quiz', async () => {
      mockPrisma.quiz.findUnique.mockResolvedValue(mockQuizData)
    ...
    it('should handle quiz with null description', async () => {
      ...
      mockPrisma.quiz.findUnique.mockResolvedValue(quizWithNullDescription)
    ...
    it('should handle empty explanation in options', async () => {
      ...
      mockPrisma.quiz.findUnique.mockResolvedValue(quizWithEmptyExplanation)
